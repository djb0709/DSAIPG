...
public class FourAryHeapBenchmarkFloyd{
    ...
    public static void main(String[] args) throws PQException {
        ...
        Supplier<PriorityQueue4Ary<Integer>> supplier = () -> {
            return new PriorityQueue4Ary<>(M, true, Comparator.comparing(Integer::intValue), true);
        };
        ...
        Benchmark_Timer<PriorityQueue4Ary<Integer>> benchmark = new Benchmark_Timer<>(
                ...
                pqInstance -> {
                    ...
                    System.out.printf("[4-ary-floyd] Insertion: %.3f ms, Removal: %.3f ms\n",
        ...
        //
        System.out.printf("4ary with floyd (M=%d, inserts=%d, removes=%d), average total time: %.5f ms%n",
